...
/// They are written by the `ActivityProvisioner` CLI (run locally) and read by the
/// authentication middleware on every protected API call. The raw token string is
...
public struct BearerTokenRecord: Sendable {
    ...
    /// Human-readable description (e.g. "minted via ActivityProvisioner CLI").
