...
```bash
sshpass -p "$RUNNER_VM_PASSWORD" scp -o StrictHostKeyChecking=no -r /Users/spar/web-local/activity.happitec.com/.claude/worktrees/agent-a3c2f787/Sources admin@$(tart ip linux-runner):~/actions-runner/_work/activity.happitec.com/activity.happitec.com/Sources
sshpass -p "$RUNNER_VM_PASSWORD" scp -o StrictHostKeyChecking=no -r /Users/spar/web-local/activity.happitec.com/.claude/worktrees/agent-a3c2f787/Tests admin@$(tart ip linux-runner):~/actions-runner/_work/activity.happitec.com/activity.happitec.com/Tests
```
